...
export const HIDS_INSTITUTION_NAME = "Himachal Institute of Dental Sciences";

// Fields faculty can submit an edit request for (subject to admin approval).
// Everything except email (their login identifier, unchangeable via
// self-service) is now included per admin decision — designation,
// department, and appointment dates included. Qualifications and
// Employment History are handled separately as list-level requests
// (see FACULTY_EDITABLE_LIST_FIELDS) since they're arrays, not scalars.
...
export const FIELD_LABELS: Record<string, string> = {
  ...
  department_id: "Department", present_designation: "Present Designation", doj_hids: "Date of Joining HIDS",
  present_appt_order_no: "Present Appt. Order No.", present_appt_order_date: "Present Appt. Order Date",
  last_college_name: "Last College Name", last_college_designation: "Last College Designation",
  last_college_relieving_date: "Last College Relieving Date",
  previous_appt_order_no: "Previous Appt. Order No.", previous_appt_order_date: "Previous Appt. Order Date",
  previous_relieving_order_no: "Previous Relieving Order No.", previous_relieving_order_date: "Previous Relieving Order Date",
  ...
  qualifications: "Qualifications", employment_history: "Employment History (manually entered)",
};
